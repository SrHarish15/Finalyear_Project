...
CREATE TABLE `faculty` (
  `Fid` varchar(35) NOT NULL,
  `Fpass` varchar(35) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `faculty` (`Fid`, `Fpass`) VALUES
('faculty', 'faculty');


CREATE TABLE `student` (
  `Sid` varchar(35) NOT NULL,
  `Spass` varchar(35) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `student` (`Sid`, `Spass`) VALUES
('student', 'student');
...
--
-- Dumping data for table `studenttables`
--

INSERT INTO `studenttables` (`Eno`, `FName`, `LName`, `FaName`, `Addrs`, `Gender`, `Course`, `DOB`, `PhNo`, `Pass`, `Eid`, `Job`) VALUES
(98908, ',nk', '?,mnf', 'smnffmdnj', 'chennai', 'male', ',m.sc', '2003-01-14', 8778777878, ' pass', 'jhgyufgvyug', 'Fresher'),
(761523, 'jhava', 'ajbhb', 'ajndjkbkja', 'chennai', '22', 'M.sc', '2003-02-14', 8782386575, 'paa', ',msnb', 'Fresher'),
(761524, ',nk', '?,mnf', 's,mnf,,fmdnj', ',mzdjv', 'mnbhvh', ',jknk', '2003-02-14', 8778777878, ', m ,', 'jhgyufgvyug', 'Fresher'),
(7987709, ',nk', '?,mnf', 'smnffmdnj', 'chennai', 'male', ',m.sc', '2003-01-14', 8778777878, ' pass', 'jhgyufgvyug', 'Fresher'),
(76134553, ',nk', '?,mnf', 'smnffmdnj', 'chennai', 'male', ',m.sc', '2003-01-14', 8778777878, ' pass', 'jhgyufgvyug', 'Fresher'),
(76152423, ',nk', '?,mnf', 'smnffmdnj', 'chennai', 'male', ',m.sc', '2003-01-14', 8778777878, ' pass', 'jhgyufgvyug', 'Fresher'),
(146891650, 'Robert', 'Huffman', 'Jason Huffman', '220  Cardinal Lane', 'Male', 'BIT', '1996-07-16', 7010101250, 'password', 'robert@gmail.com', 'Fresher'),
(146891651, 'Martin', 'Huynh', 'Anthony Huynh', '3936  Brighton Circle Road', 'Male', 'MIT', '1996-08-05', 7023658960, 'password', 'martin@gmail.com', 'Fresher'),
(146891652, 'June', 'Barker', 'Peter Barker', '4871  Romano Street', 'Female', 'BIT', '1996-02-10', 7410000010, 'password', 'barker@gmail.com', 'Fresher'),
(146891654, 'John', 'Greenwood', 'Thomas M Greenwood', '1495  Wilmar Farm Road', 'Male', 'BIT', '1996-07-12', 7013696365, 'password', 'greenwood@gmail.com', 'Fresher'),
(146891655, 'Kathy', 'Dales', 'Stewart Dales', '1318  Hilltop Street', 'Female', 'MIT', '1993-11-03', 7014563320, 'password', 'kathy@gmail.com', 'Fresher'),
(146891656, 'Robb', 'Caldwell', 'James Caldwell', '3590  White River Way', 'Male', 'BIT', '1997-04-01', 7036580002, 'password', 'robb@gmail.com', 'Fresher'),
(146891657, 'Christine', 'Meadow', 'Johnny M Meadow', '662  Frederick Street', 'Female', 'BIT', '1995-08-25', 70258666660, 'password', 'christine@gmail.com', 'Fresher'),
(146891658, 'Francisca', 'Ashley', 'George Ashley', '3828  Pine Garden Lane', 'Female', 'BIT', '1994-11-03', 7014524580, 'password', 'ashley@gmail.com', 'Fresher'),
(146891659, 'Jason', 'Robinson', 'Mark L Robinson', '4916  Melm Street', 'Male', 'BIT', '1997-11-13', 7023699630, 'password', 'json@gmail.com', 'Fresher'),
(146891662, 'Liam', 'Moore', 'Stephen Moore', '2587 Ralph Street', 'Male', 'BIT', '1996-02-12', 7410002587, 'password', 'liamoore@gmail.com', 'Fresher'),
(146891663, 'Rachel', 'Rufus', 'Jordan Rufus', '3898 Mulberry Lane', 'Female', 'BIT', '1998-11-01', 7014445836, 'password', 'rachel@gmail.com', 'Fresher'),
(146891672, '', '', '', '', '', '', '0000-00-00', 0, '', '', 'Fresher'),
(146891674, '', '', '', '', '', '', '0000-00-00', 0, '', '', 'Fresher'),
(146891676, '', '', '', '', '', '', '0000-00-00', 0, '', '', ''),
(146891678, '', '', '', '', '', '', '0000-00-00', 0, '', '', '');
--
-- Table structure for table `result`
--
CREATE TABLE `tblauthors` (
  `id` int(11) NOT NULL,
  `StudentName` varchar(159) DEFAULT NULL,
...
INSERT INTO `tblauthors` (`id`, `StudentName`, `JobDescription`, `CompanyName`, `Address`) VALUES
(1, 'AARON C', 'Fresher', 'FutureUpdate', 'FutureUpdate'),
(2, 'ANBUSELVAN T', 'Fresher', 'FutureUpdate', 'FutureUpdate'),
(3, 'BARATH KUMAR E', 'Fresher', 'FutureUpdate', 'FutureUpdate'),
(4, 'DEEPAK T', 'Fresher', 'FutureUpdate', 'FutureUpdate'),
(5, 'EZHILARASI S', 'Fresher', 'FutureUpdate', 'FutureUpdate'),
(6, 'GANESH L', 'Fresher', 'FutureUpdate', 'FutureUpdate'),
(7, 'GOKULAVASAN K', 'Fresher', 'FutureUpdate', 'FutureUpdate'),
(8, 'HARISH R', 'Fresher', 'FutureUpdate', 'FutureUpdate'),
(9, 'JAYAKANTHAN A', 'Fresher', 'FutureUpdate', 'FutureUpdate'),
(10, 'KAMESH R', 'Fresher', 'FutureUpdate', 'FutureUpdate'),
(11, ' LOGESH D', 'Fresher', 'FutureUpdate', 'FutureUpdate'),
(12, 'MADHAVAN V', 'Fresher', 'FutureUpdate', 'FutureUpdate'),
(13, 'MADHUMITHA V', 'Fresher', 'FutureUpdate', 'FutureUpdate'),
(14, 'PRAKASH A', 'Fresher', 'FutureUpdate', 'FutureUpdate'),
(15, 'SANTHOSH M', 'Fresher', 'FutureUpdate', 'FutureUpdate'),
(16, 'SURENDAR T', 'Fresher', 'FutureUpdate', 'FutureUpdate'),
(17, 'VALLARASU', 'Fresher', 'FutureUpdate', 'FutureUpdate'),
(18, 'VINOTH KUMAR K', 'Fresher', 'FutureUpdate', 'FutureUpdate'),
(19, 'VISHNU D', 'Fresher', 'FutureUpdate', 'FutureUpdate'),
(20, 'YAMINI K', 'Fresher', 'FutureUpdate', 'FutureUpdate'),
(21, 'YUVAPRIYA R', 'Fresher', 'FutureUpdate', 'FutureUpdate');
...
/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNE
