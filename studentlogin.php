    ...
    <div class="container">
        ...
        <form name="studentlogin" action="loginlinkstudent.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="sid" placeholder="Enter your Student ID" required>
            </div>
            
            <!-- Password Field -->
            <div class="form-group">
                <i class="fas fa-lock input-icon"></i>
                <input type="password" class="form-control" name="spass" placeholder="Enter your Password" required>
            </div>
