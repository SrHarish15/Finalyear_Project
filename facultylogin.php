    ...
    <div class="container">
        ...
        <form name="facultylogin" action="loginlinkfaculty.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="fid" placeholder="Enter your Admin ID" required>
            </div>
            
            <!-- Password Field -->
            <div class="form-group">
                <i class="fas fa-lock input-icon"></i>
                <input type="password" class="form-control" name="fpass" placeholder="Enter your Password" required>
            </div>
